...
// Given a number num, our task is to find the closest Palindrome number whose absolute 
// difference with given number is minimum. If 2 Palindome numbers have same absolute difference 
// from the given number, then find the smaller one.
